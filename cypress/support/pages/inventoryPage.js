...
class InventoryPage {
        ...
        addToCartButton: (productName) => cy.get(inventoryLocators.addToCartButton(productName)),        
        removeToCartButton: (productName) => cy.get(inventoryLocators.removeToCartButton(productName))
    };
